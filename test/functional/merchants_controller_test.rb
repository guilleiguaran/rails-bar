...
class MerchantsControllerTest < ActionController::TestCase
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post :create, merchant: { email: @merchant.email, name: @merchant.name, phone: @merchant.phone, tin: @merchant.tin, web: @merchant.web }
    end
  ...
  test "should update merchant" do
    put :update, id: @merchant, merchant: { email: @merchant.email, name: @merchant.name, phone: @merchant.phone, tin: @merchant.tin, web: @merchant.web }
    assert_redirected_to merchant_path(assigns(:merchant))
  end
